...
REAP transforme un modèle « inservable » (590 Go) en cible réaliste : 50 % d'experts en moins ≈ moitié moins de VRAM, sans réentraîner. Combiné à du 4-bit, un 295B peut viser un serveur multi-GPU au lieu d'un cluster. Si tu déploies du LLM auto-hébergé, surveille les checkpoints REAP officiels avant d'acheter du GPU : tu paies souvent pour des experts que ton usage n'active jamais.

### Points de vigilance

La qualité chute davantage hors des tâches de calibration. Valide la variante élaguée sur **tes** prompts métier avant prod, pas seulement sur les benchmarks publics.
