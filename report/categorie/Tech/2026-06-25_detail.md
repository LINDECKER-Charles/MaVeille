...
À ce stade, aucune exploitation massive « in the wild » n'est rapportée : il s'agit d'une démonstration de recherche, pas d'une campagne active. La chaîne reste néanmoins crédible car elle n'emprunte que des mécanismes documentés de macOS. XM Cyber annonce un outil open source, **XPC Hunter**, pour auditer les services XPC trop permissifs, et promet les détails techniques complets à **Black Hat USA 2026**. En attendant, mets à jour ton agent Kandji, applique les détections CrowdStrike, et si tu maintiens un service XPC, audite ses méthodes privilégiées dès maintenant. Détails complémentaires : https://appleinsider.com/articles/26/06/24/new-macos-security-flaw-could-let-hackers-disable-protection-tools-researchers-say
